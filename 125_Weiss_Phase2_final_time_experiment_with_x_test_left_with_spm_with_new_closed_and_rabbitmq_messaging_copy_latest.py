# -*- coding: utf-8 -*-
"""
Created on Tue Feb  2 14:24:54 2021
...
#        ReconDF.columns = ['TaskID', 'csc','ReconPurpose','collection_meo','RequestId']
        ...
        #for setup_code in setup_code_list:
            ...
            date_to_analyze = '18012021'
            penultimate_date_to_analyze = '17012021'
...
#            print(f"It took {mem_diff_m_after_reading_meo} Mb to execute this method")
            ...
            #Change added on 17-12-2020 by Rohit to include filter on ob and smb. Below if statement is commented out and new if statement is included
                    if(('ViewData.Source Combination Code' in list(ob.columns)) & ('ViewData.Source Combination Code' in list(smb.columns))):
            ...
            def ui_action_column(param_final_df):
                ...
                param_final_df.loc[((param_final_df['ML_flag'] == 'Not_Covered_by_ML')),'ActionCode'] = 7    
                param_final_df.loc[((param_final_df['Predicted_Status'] == 'OB') & (param_final_df['PredictedComment'] == '') & (param_final_df['ML_flag'] == 'ML')),'ActionCode'] = 6
                param_final_df.loc[((param_final_df['Predicted_Status'] == 'OB') & (param_final_df['PredictedComment'] != '') & (param_final_df['ML_flag'] == 'ML')),'ActionCode'] = 3
                param_final_df.loc[((param_final_df['Predicted_Status'] == 'UCB') & (param_final_df['PredictedComment'] == '') & (param_final_df['ML_flag'] == 'ML')),'ActionCode'] = 2
                param_final_df.loc[((param_final_df['Predicted_Status'].isin(['UMB','UMR','UMT'])) & (param_final_df['PredictedComment'] == '') & (param_final_df['ML_flag'] == 'ML')),'ActionCode'] = 1
                param_final_df.loc[((param_final_df['Predicted_Status'].isin(['UMB','UMR','UMT'])) & (param_final_df['PredictedComment'] != '') & (param_final_df['ML_flag'] == 'ML')),'ActionCode'] = 4
                param_final_df['ActionCode'] = param_final_df['ActionCode'].astype(str)
