...
date_to_analyze = '11032021'
penultimate_date_to_analyze = '10032021'
...
df2 = df2.drop(['zero_list', 'diff_len', 'remove_mark',
       'remove_mark_fin','remove_mark_new','day','conversion'], axis = 1)
df2 = df2.reset_index()
