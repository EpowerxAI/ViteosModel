...
base_dir = os.path.join(base_dir, 'BD_of_%s' % date_i)
...
# create dynamic name with date as folder
base_dir_plus_Lombard = os.path.join(base_dir, 'Lombard')
...
# create dynamic name with date as folder
base_dir_plus_Lombard_plus_249 = os.path.join(base_dir_plus_Lombard, '249')
...
double6['ViewData.Status'].value_counts()
...
final_df_filename_list_inside_Lombard_249_folder.append('Lombard/249/umb lombard 249 carryforward.csv')
