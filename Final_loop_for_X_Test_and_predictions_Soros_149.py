...
f = open('149_model_run_' + str(datetime.now().strftime("%d_%m_%Y_%H_%M")) + '.txt', 'w')
sys.stdout = f
...
'CP Net Amount',
#'CP Net Amount Difference','CP Net Amount Difference Absolute',
'BreakID',
...
#'Bloomberg_Yellow_Key',
'CP Net Amount',
#'CP Net Amount Difference',
#'CP Net Amount Difference Absolute',
'BreakID',
'Business Date',
#'Call Put Indicator',
'Cancel Amount',
...
dates_with_error_149 = [3,16,21,22,24]

filepaths_X_test = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/X_Test_149/x_test_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_no_pair_id_data = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/X_Test_149/no_pair_ids_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_no_pair_id_no_data_warning = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/X_Test_149/WARNING_no_pair_ids_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_AUA = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/AUA/AUA_HST_RecData_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_MEO = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/MEO/MEO_HST_RecData_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_final_prediction_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/Final_Predictions_149/Final_Predictions_Table_HST_RecData_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_accuracy_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/Final_Predictions_149/Accuracy_Table_HST_RecData_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_crosstab_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/Final_Predictions_149/Crosstab_Table_HST_RecData_149_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
...
# In[4726]:
    ...
    df = df.rename(columns= {'ViewData.CP Net Amount':'ViewData.B-P Net Amount'})
...
# In[4985]:
    if test_file['SideB.ViewData.CUSIP'].isnull().values.all() == True: 
        print("\ntest_file['SideB.ViewData.CUSIP'] is a NaN column\n")
...
# Actual class predictions
    ...
    if prediction_table['Final_predicted_break'].isnull().values.all() == True: 
        print("\nprediction_table['Final_predicted_break']\n")
    prediction_table['Final_predicted_break'] = prediction_table['Final_predicted_break'].astype(str) 
