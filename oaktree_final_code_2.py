...
date_to_analyze = '23122020'
penultimate_date_to_analyze = '22122020'
...
filepaths_final_df_2_after_making_umt_from_umr = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_after_making_umt_from_umr_setup_' + setup_code + '_date_' + str(date_i) + '_to_check_for_defects.csv'
...
filepaths_final_df_2 = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_setup_' + setup_code + '_date_' + str(date_i) + '_after_abhijeet_change_on_09_01_2021.csv'
