...
f = open('1045_model_run_' + str(datetime.now().strftime("%d_%m_%Y_%H_%M")) + '.txt', 'w')
sys.stdout = f
...
date_numbers_list = [1,2,3,
                     7,8,9,10,
                     14,15,
                     21,22,24,
                     29,30]

dates_with_error_1045 = [4,11,16,17,18,23,25,28]
# Error for dates 4,11,16,25
...
# Error for dates 17,18,23,28
#Statement : test_file = pd.concat(training_df)
#ValueError: No objects to concatenate


filepaths_X_test = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/X_Test_1045/x_test_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_no_pair_id_data = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/X_Test_1045/no_pair_ids_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_no_pair_id_no_data_warning = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/X_Test_1045/WARNING_no_pair_ids_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_AUA = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/AUA/AUACollections.AUA_HST_RecData_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_MEO = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/MEO/MeoCollections.MEO_HST_RecData_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_final_prediction_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/Final_Predictions_1045/Final_Predictions_Table_HST_RecData_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_accuracy_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/Final_Predictions_1045/Accuracy_Table_HST_RecData_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_crosstab_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/HIG_Capital/JuneData/Final_Predictions_1045/Crosstab_Table_HST_RecData_1045_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
...
for i in range(0,len(date_numbers_list)):
    ...
    meo = meo.rename(columns={'ViewData.Cust Net Amount':'ViewData.B-P Net Amount'})
...
# In[5632]:
    ...
    aua_final = aua_final.rename(columns={'ViewData.Cust Net Amount':'ViewData.B-P Net Amount'})
