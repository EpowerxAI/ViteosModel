...
final_table_to_write['TaskID'] = final_table_to_write.apply(lambda x: get_TaskID_from_list_first_element_as_single_string_of_Side_01_UniqueIds(fun_meo_df = meo_df, fun_row = x), axis=1)
final_table_to_write['SourceCombinationCode'] = final_table_to_write.apply(lambda x: get_SourceCombinationCode_from_list_first_element_as_single_string_of_Side_01_UniqueIds(fun_meo_df = meo_df, fun_row = x), axis=1)
...
final_df_2 = final_table_to_write[cols_for_database]
