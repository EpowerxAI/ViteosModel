...
test_file['SideB.ViewData.Settle Date'].fillna(9, inplace = True)
test_file['SideA.ViewData.Settle Date'].fillna(9, inplace = True)
...
if(len(duplicate_ids_final_umr_table_Side1) != 0):
    ...
    final_umr_table_duplicates_Side1 = final_umr_table_duplicates_Side1[['SideB.ViewData.Side0_UniqueIds','SideA.ViewData.Side1_UniqueIds','SideB.ViewData.BreakID_B_side','SideA.ViewData.BreakID_A_side','Predicted_action','probability_No_pair','probability_UMB','probability_UMR']]
