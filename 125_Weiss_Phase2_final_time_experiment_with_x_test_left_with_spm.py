...
#Change added on 18-12-2020 after business told us that Custodian Account,TranID and amount should match and we can close then also
        Transaction_type_closed_break_df_3 = \
            fun_side_meo_combination_df[ \
                                        (fun_side_meo_combination_df['ViewData.Custodian Account_x'].astype(str) == fun_side_meo_combination_df['ViewData.Custodian Account_y'].astype(str)) & \
                                        (fun_side_meo_combination_df['ViewData.Transaction ID_x'].astype(str) == fun_side_meo_combination_df['ViewData.Transaction ID_y'].astype(str)) & \
                                        (fun_side_meo_combination_df[Side_0_1_UniqueIds_col_name_list[0]].astype(str) != fun_side_meo_combination_df[Side_0_1_UniqueIds_col_name_list[1]].astype(str)) \
                                         ]
...
#Change added on 18-12-2020 after business told us that Custodian Account,TranID and amount should match and we can close then also
        Transaction_type_closed_break_df = Transaction_type_closed_break_df.append(Transaction_type_closed_break_df_3)
    ...
    if(fun_setup_code == '125'):
        Transaction_Type_dict = {
                                ...
                                'Dividend Acct_side' : {'side' : 'Acct',
                                           'Transaction_Type' : ['Dividend'],
                                           'Side_meo_training_df' : Acct_meo_training_df},
#Change Added new code for closed on 14-12-2020 to catch very simple newly added non interacting cancel corrections                                                        
...
#
#meo_filename = '//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Weiss/meo_df_setup_125_date_2020-12-14.csv'
...
filepaths_final_df_2_before_making_umt_from_umr = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_before_making_umt_from_umr_setup_' + setup_code + '_date_' + str(date_i) + '.csv'
...
filepaths_final_df_2_after_making_umt_from_umr = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_after_making_umt_from_umr_setup_' + setup_code + '_date_' + str(date_i) + '.csv'
...
filepaths_final_df_2 = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_setup_' + setup_code + '_date_' + str(date_i) + '_5.csv'
