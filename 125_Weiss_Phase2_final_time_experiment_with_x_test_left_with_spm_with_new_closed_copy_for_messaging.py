...
date_to_analyze = '18022021'
penultimate_date_to_analyze = '17022021'
...
closed_df_list = []
for transaction_type_for_closing_value in mapping_dict_trans_type_125:
    if(meo_for_closed[meo_for_closed['Transaction_Type_for_closing'] == transaction_type_for_closing_value].shape[0] != 0):
        ...
        meo_for_transaction_type_for_closing_value = interacting_closing(meo_for_transaction_type_for_closing_value_input)
        All_combination_df = All_combination_file(fun_df = meo_for_transaction_type_for_closing_value)
        if(All_combination_df.shape[0] != 0):
            closed_df_for_transaction_type_for_closing_value = identifying_closed_breaks(param_all_meo_combination_df = All_combination_df, \
                                                                     param_setup_code_crucial = setup_code, \
                                                                     param_trans_type_1 = ViteosClosed.mapping_dict_trans_type_125.get(transaction_type_for_closing_value)[0], \
                                                                     param_trans_type_2 = ViteosClosed.mapping_dict_trans_type_125.get(transaction_type_for_closing_value)[1])
...
coll_1_for_writing_prediction_data.remove({ "BusinessDate": ViteosMongoDB_Query.getDateTimeFromISO8601String(date_to_analyze_ymd_iso_00_00_format), "SetupID": int(setup_code)})
coll_2_for_writing_prediction_data_in_ReconDB_ML_Testing.remove({ "BusinessDate": ViteosMongoDB_Query.getDateTimeFromISO8601String(date_to_analyze_ymd_iso_00_00_format), "SetupID": int(setup_code)})
...
query_for_Task_collection = ReconDB_ML_137_server['Tasks'].find({ "BusinessDate": ViteosMongoDB_Query.getDateTimeFromISO8601String(penultimate_date_to_analyze_ymd_iso_18_30_format), 
