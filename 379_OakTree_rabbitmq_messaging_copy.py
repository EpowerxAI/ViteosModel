...
def interacting_closing_125(fun_df): #The name of the function contains 125 but it is also being used in 379
...
filepaths_no_pair_id_data = '//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/' + client + '/UAT_Run/X_Test_' + setup_code + '/no_pair_ids_' + setup_code + '.csv'
filepaths_no_pair_id_no_data_warning = '//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/' + client + '/UAT_Run/X_Test_' + setup_code + '/WARNING_no_pair_ids_' + setup_code + '.csv'

while True:
    try:
      s2_out = subprocess.check_output([sys.executable, 'D:/ViteosModel/Setup_125_ML2_RMQ_Receive.py'])
    except Exception:
        data = None
