...
#meo_filename = '//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Weiss/meo_df_setup_125_date_2020-11-23.csv'
...
#filepaths_X_test = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\X_Test_for_Pratik_setup_' + setup_code + '_date_' + str(date_i) + '_3.csv'
