...
filepaths_final_open_table = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_open_table_setup_' + setup_code + '_date_' + str(date_i) + '_rerun_for_business.csv'
final_open_table.to_csv(filepaths_final_open_table)
...
if(final_df.shape[0] != 0):
	...
	final_df = pd.DataFrame()
	filepaths_final_df = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_setup_' + setup_code + '_date_' + str(date_i) + '_rerun_for_business.csv'
