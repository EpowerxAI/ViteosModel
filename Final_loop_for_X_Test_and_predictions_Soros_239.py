...
f = open('239_model_run_' + str(datetime.now().strftime("%d_%m_%Y_%H_%M")) + '.txt', 'w')
sys.stdout = f
...
filepaths_X_test = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/X_Test_239/x_test_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_no_pair_id_data = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/X_Test_239/no_pair_ids_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_no_pair_id_no_data_warning = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/X_Test_239/WARNING_no_pair_ids_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_AUA = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/AUA/AUA_HST_RecData_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_MEO = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/MEO/MEO_HST_RecData_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_final_prediction_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/Final_Predictions_239/Final_Predictions_Table_HST_RecData_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_accuracy_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/Final_Predictions_239/Accuracy_Table_HST_RecData_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
filepaths_crosstab_table = ['//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/Soros/JuneData/Final_Predictions_239/Crosstab_Table_HST_RecData_239_2020-06-' + str(date_numbers_list[i]) + '.csv' for i in range(0,len(date_numbers_list))]
