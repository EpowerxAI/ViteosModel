...
def fill_trade_date_equals_0_with_settle_date_apply_row(param_row,param_column_to_fill_for, param_column_to_fill_with):	
...
date_to_analyze = '22022021'
penultimate_date_to_analyze = '21022021'
...
result_non_trade['ViewData.Settle Date'] = result_non_trade.apply(lambda row : fill_trade_date_equals_0_with_settle_date_apply_row(param_row = row,param_column_to_fill_for = 'ViewData.Settle Date', param_column_to_fill_with = 'ViewData.Trade Date'), axis = 1, result_type="expand")
...
result_non_trade['ViewData.Trade Date'] = result_non_trade.apply(lambda row : fill_trade_date_equals_0_with_settle_date_apply_row(param_row = row,param_column_to_fill_for = 'ViewData.Trade Date', param_column_to_fill_with = 'ViewData.Settle Date'), axis = 1, result_type="expand")
