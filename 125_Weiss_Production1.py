...
#        ReconDF.columns = ['TaskID', 'csc','ReconPurpose','collection_meo','RequestId']
        ...
        print('ReconDF')
        print(ReconDF)
        ReconDF_filepath = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + str(client) + '\\ReconDF_messages\\ReconDF_setup_' + str(setup_code) + '_date_' + str(today) + '_' + str(while_loop_iterator) + '_loop2.csv'
...
#            meo_df_for_sending_message = meo_df[~meo_df['ViewData.Status'].isin(['SMT','HST', 'OC', 'CT', 'Archive','SMR'])]
                ...
                ob_carry_forward_df = meo_df[(meo_df['ViewData.Status'] == 'OB') | (meo_df['ViewData.Status'] == 'UOB')]                
    ...
    #            print(f"It took {mem_diff_m_after_reading_meo} Mb to execute this method")
                ...
                if(len(training_df) != 0):
                    ...
                    filename2 = 'Weiss_umt_two_step_loop_2.sav'
